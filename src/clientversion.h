...
#error Client version information missing: version is not defined by but-config.h or in any other way
#endif
...
/**
 * butd-res.rc includes this file, but it cannot cope with real c++ code.
