    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  but-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the But in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more information, see the <a href=\"https://docs.butkoin.com/en/stable/wallets/but/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
