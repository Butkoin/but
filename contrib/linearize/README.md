# Linearize
Construct a linear, no-fork, best version of the But blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install but_hash

https://github.com/but/but_hash
...
JSON-RPC server. Running `butd` or `but-qt -server` will be sufficient.
...
* `input`: butd blocks/ directory containing blkNNNNN.dat
