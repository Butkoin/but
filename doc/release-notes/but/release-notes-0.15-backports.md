...
- [`a1bd147bc`](https://github.com/ButKoin/but/commit/a1bd147bc) Butify
...
- [`c35aa663b`](https://github.com/ButKoin/but/commit/c35aa663b) Merge #11326: Fix crash on shutdown with invalid wallet
...
- [`76776fb62`](https://github.com/ButKoin/but/commit/76776fb62) Merge #11017: [wallet] Close DB on error.
...
- [`ebfec2218`](https://github.com/ButKoin/but/commit/ebfec2218) Butify BITCOINCLI
...
- [`05ad6d2ec`](https://github.com/ButKoin/but/commit/05ad6d2ec) change nEnd to index (might break the progress bar on wallet creation, should test)
...
- [`de1342791`](https://github.com/ButKoin/but/commit/de1342791) Merge #10314: Remove unused forward declaration for non-existent ScriptPubKeyToJSON(...)
...
- [`50fee01e3`](https://github.com/ButKoin/but/commit/50fee01e3) Merge #10963: [bench] Restore format state of cout after printing with std::fixed/setprecision
...
- [`52aef4cfe`](https://github.com/ButKoin/but/commit/52aef4cfe) Merge #10301: Check if sys/random.h is required for getentropy.
...
- [`dc97d48bb`](https://github.com/ButKoin/but/commit/dc97d48bb) Merge #10760: Avoid dereference-of-casted-pointer
...
- [`b195cbb5e`](https://github.com/ButKoin/but/commit/b195cbb5e) Merge #10651: Verify binaries from bitcoincore.org and bitcoin.org
...
- [`41b386903`](https://github.com/ButKoin/but/commit/41b386903) Merge #10400: [RPC] Add an uptime command that displays the amount of time (in seconds) bitcoind has been running
...
- [`0d52db844`](https://github.com/ButKoin/but/commit/0d52db844) scripted-diff: Remove Q_FOREACH #10502 `-BEGIN VERIFY SCRIPT- sed -i 's/Q_FOREACH *(\(.*\),/for (\1 :/' ./src/*.h ./src/*.cpp ./src/*/*.h ./src/*/*.cpp ./src/*/*/*.h ./src/*/*/*.cpp ; -END VERIFY SCRIPT-`
...
- [`de33753f0`](https://github.com/ButKoin/but/commit/de33753f0) Revert "Merge #10376: [tests] fix disconnect_ban intermittency"
...
- [`2ab30b846`](https://github.com/ButKoin/but/commit/2ab30b846) Merge #10475: [RPC] getmempoolinfo mempoolminfee is a BTC/KB feerate
...
- [`3a0d4a1e6`](https://github.com/ButKoin/but/commit/3a0d4a1e6) Merge #10380: [doc] Removing comments about dirty entries on txmempool
...
- [`5b99bfc6f`](https://github.com/ButKoin/but/commit/5b99bfc6f) Merge #10342: [tests] Improve mempool_persist test
...
- [`82feee353`](https://github.com/ButKoin/but/commit/82feee353) Merge #10305: Fix potential NPD introduced in b297426c
...
- [`e6a0b2162`](https://github.com/ButKoin/but/commit/e6a0b2162) Add missing include for CKeyID
...
- [`29194b1f5`](https://github.com/ButKoin/but/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
...
- [`e57559a8d`](https://github.com/ButKoin/but/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/ButKoin/but/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/ButKoin/but/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/ButKoin/but/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/ButKoin/but/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/ButKoin/but/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/ButKoin/but/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/ButKoin/but/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/ButKoin/but/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/ButKoin/but/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/ButKoin/but/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/ButKoin/but/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/ButKoin/but/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/ButKoin/but/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/ButKoin/but/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/ButKoin/but/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/ButKoin/but/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/ButKoin/but/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/ButKoin/but/commit/67c735b15) s/bitcoin-config.h/but-config.h/
- [`2f63322cd`](https://github.com/ButKoin/but/commit/2f63322cd) butify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/ButKoin/but/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/ButKoin/but/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/ButKoin/but/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/ButKoin/but/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/ButKoin/but/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/ButKoin/but/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/ButKoin/but/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/ButKoin/but/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/ButKoin/but/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/ButKoin/but/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/ButKoin/but/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/ButKoin/but/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/ButKoin/but/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/ButKoin/but/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/ButKoin/but/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/ButKoin/but/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/ButKoin/but/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/ButKoin/but/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/ButKoin/but/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/ButKoin/but/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/ButKoin/but/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/ButKoin/but/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/ButKoin/but/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/ButKoin/but/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/ButKoin/but/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/ButKoin/but/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/ButKoin/but/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/ButKoin/but/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/ButKoin/but/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/ButKoin/but/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/ButKoin/but/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/ButKoin/but/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/ButKoin/but/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/ButKoin/but/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/ButKoin/but/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/ButKoin/but/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/ButKoin/but/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/ButKoin/but/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/ButKoin/but/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/ButKoin/but/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/ButKoin/but/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/ButKoin/but/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/ButKoin/but/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/ButKoin/but/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/ButKoin/but/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/ButKoin/but/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/ButKoin/but/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/ButKoin/but/commit/1cfda206a) Merge #9993: Initialize nRelockTime
