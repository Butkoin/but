...
- [`f7b71f660`](https://github.com/but/but/commit/f7b71f660) Merge #13611: [bugfix] Use `__cpuid_count` for gnu C to avoid gitian build fail.
...
- [`c35aa663b`](https://github.com/but/but/commit/c35aa663b) Merge #11326: Fix crash on shutdown with invalid wallet
...
- [`b93785d8d`](https://github.com/but/but/commit/b93785d8d) Fix maxuploadtarget.py
...
- [`1b77cc81a`](https://github.com/but/but/commit/1b77cc81a) No need to assert wait_until
...
- [`cd5a12f9f`](https://github.com/but/but/commit/cd5a12f9f) Merge #10862: Remove unused variable int64_t nEnd. Fix typo: "conditon" → "condition".
...
- [`51a4e11d6`](https://github.com/but/but/commit/51a4e11d6) butify what made sense in fuzzing.md
...
- [`dfd14bf57`](https://github.com/but/but/commit/dfd14bf57) Merge #10977: [net] Fix use of uninitialized value in getnetworkinfo(const JSONRPCRequest&)
...
- [`5dc2193d2`](https://github.com/but/but/commit/5dc2193d2) Merge #10824: Avoid unnecessary work in SetNetworkActive
...
- [`9ad533089`](https://github.com/but/but/commit/9ad533089) Merge #10803: Explicitly search for bdb5.3.
...
- [`9221e0d3c`](https://github.com/but/but/commit/9221e0d3c) Merge #10728: fix typo in help text for removeprunedfunds
...
- [`31f4a602a`](https://github.com/but/but/commit/31f4a602a) Merge #9517: [refactor] Switched httpserver.cpp to use RAII wrapped libevents.
...
- [`30c5aaead`](https://github.com/but/but/commit/30c5aaead) Merge #10578: Add missing include for atomic in db.h
...
- [`e7d7ecb6e`](https://github.com/but/but/commit/e7d7ecb6e) Set a few param values to 0 by default
...
- [`0477eb4b3`](https://github.com/but/but/commit/0477eb4b3) Merge #9539: [net] Avoid initialization to a value that is never read
...
- [`c6b926547`](https://github.com/but/but/commit/c6b926547) Merge #7958: Remove useless argument to AlertNotify.
...
- [`fc5e461ee`](https://github.com/but/but/commit/fc5e461ee) Merge #10222: [tests] test_runner - check unicode
...
- [`b76b91d82`](https://github.com/but/but/commit/b76b91d82) Merge #10197: [tests] Functional test warnings
...
- [`6afa605f6`](https://github.com/but/but/commit/6afa605f6) Pass disconnected/deleted pindex instead of pprev into BlockDisconnected
...
- [`14001a3d9`](https://github.com/but/but/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
...
- [`e5ecff6e8`](https://github.com/but/but/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
...
- [`07ed44df6`](https://github.com/but/but/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/but/but/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/but/but/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/but/but/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/but/but/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/but/but/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/but/but/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/but/but/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/but/but/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/but/but/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/but/but/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/but/but/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/but/but/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/but/but/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/but/but/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/but/but/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/but/but/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/but/but/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/but/but/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/but/but/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/but/but/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/but/but/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/but/but/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/but/but/commit/1cfda206a) Merge #9993: Initialize nRelockTime
