...
class LLMQCoinbaseCommitmentsTest(ButTestFramework):
    def set_test_params(self):
        self.set_but_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ButTestFramework doesn't support this atm)
